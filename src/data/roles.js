...
let Washerwoman = new Role('Washerwoman', 'townsfolk', true, true, 2, 'You point at two players and give washerwoman a townfolk class of one of them.', 'Skip the rest of nights', false, false, false, null, null);
// -Librarian: 1 "Outsider", 1 "Wrong"
let Librarian = new Role('Librarian', 'townsfolk', true, true, 3, 'You point at two players and give librarian an outsider class of one of them.', 'Skip the rest of nights', false, false, false, null, null);

// -Investigator: 1 "Minion", 1 "Wrong"
let Investigator = new Role('Investigator', 'townsfolk', true, true, 4, 'You point at two players and give investigator minion class of one of them', 'Skip the rest of nights', false, false, false, null, null);

// -Chef
let Chef = new Role('Chef', 'townsfolk', true, true, 5, 'You give the number of evil players next to each other', 'You give the number of evil players next to each other', false, false, false, null, null);

// -Empath
let Empath = new Role('Empath', 'townsfolk', true, true, 6, 'You give the number of evil players next empath', 'You give the number of evil players next to empath', false, false, false, null, null);

// -Fortune Teller: 1 "Red Herring"
let FortuneTeller = new Role('Fortune Teller', 'townsfolk', true, true, 7, 'Fortune Teller picks 2 players, if one of them is the deamon give Fortune Teller a yes, red herring registers falsly.', 'Fortune Teller picks 2 players, if one of them is the deamon give them yes, red herring registers falsly.', false, false, false, null, null);
...
// // Outsiders
// -Butler: 1 "Master"
let Butler = new Role('Butler', 'outsider',  true, true, 9, 'Every night must pick master and may vote only if master does.', null, false, false, false, true, 'Every night must pick master and may vote only if master does.');
...
let Poisoner = new Role('Poisoner', 'minion',  true, true, 1, 'Learn who the demon is.', 1, 'Chooses a player, that players ability malcunction next 24h.', false, false, false, null, null);
...
// Demon
// -Imp: 1 "Attacked"
let Imp = new Role('Imp', 'demon',  true, true, true, 'Learn who minions are and 3 roles not in play.', 'Each night you attack a player, they die. If you attack yourself a minion becomes imp', false, false, false, null, null);
